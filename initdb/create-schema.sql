...
-- Create 'QGIS Remote' connection with parameters and permission for guacadmin

-- 1. Insert the connection definition
INSERT INTO guacamole_connection (connection_name, protocol)
VALUES ('QGIS Remote', 'vnc');

-- 2. Get the generated connection ID
SET @connection_id := LAST_INSERT_ID();

-- 3. Insert connection parameters including password
...
-- 4. Grant READ permission on the connection to the user 'guacadmin'
